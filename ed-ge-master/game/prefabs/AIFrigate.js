...
export default class AIFrigate extends Base.GameObject {
  constructor(x, y) {
    super(x, y, 2);
    let rectangleComponent = new Components.RectangleComponent(20, 40, "blue", "blue");
    ...
    let shipMovementBehavior = new AIShipMovementBehavior(10, .1);
